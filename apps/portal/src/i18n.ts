...
const M = {
  en: {
    ...
    "c.keys.name": "What will use it? e.g. HR scheduler", "c.keys.create": "Create key", "c.keys.revoke": "Revoke", "c.keys.none": "No keys yet.",
  ...
  he: {
    ...
    "c.keys.name": "מה ישתמש בו? למשל: מתזמן HR", "c.keys.create": "יצירת מפתח", "c.keys.revoke": "ביטול", "c.keys.none": "עדיין אין מפתחות.",
