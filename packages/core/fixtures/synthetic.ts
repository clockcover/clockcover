...
export const employer: Employer = { id: "emp-1", name: "Example Logistics", payrollEmail: "payroll@example.com", timezone: "UTC", operatorEmail: "operator@example.com", slaHours: 48, locale: "en" };
