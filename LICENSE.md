...
Licensed Work: ClockCover (the "Software")
...
attendance-gap detection or payroll-digest routing service that competes
with ClockCover. Internal use within your own organization, including
running it for your own or your clients' payroll operations without
reselling the Software itself as a service, is permitted.
