...
| ADR                                                           | Title                                                                            | Status   |
| ------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------- |
| [0001](0001-typescript-on-cloudflare-until-first-customer.md) | TypeScript on Cloudflare (Workers + D1) until first customer, then self-host     | accepted |
...
| [0004](0004-digest-access-by-signed-link.md)                  | Managers reach their digest through a signed, expiring link — no accounts        | proposed |
